...
const TEMAS_RAW: TemaContenido[] = [
    ...
    preguntas: [
      ...
      },
      {
        ...
        opciones: [
          ...
          "Un compromiso entre la defensa que rechaza y lo reprimido que pugna por volver: el síntoma satisface a medias a las dos fuerzas.",
          "Una negociación entre paciente y analista.",
          "El precio del tratamiento.",
        ],
        correcta: 1,
        exp: "El síntoma es transacción: contiene algo de la defensa (el contenido no se reconoce) y algo de lo reprimido (algo de él se expresa). Ninguna fuerza gana del todo. Por eso el síntoma es opaco para el sujeto.",
      },
      {
      ...
      {
        q: "¿Por qué Freud sostiene que el síntoma es 'transacción' y no simplemente 'producto' de la defensa?",
        opciones: [
          "Porque cuesta dinero curarlo.",
          "Porque el síntoma resulta del compromiso entre dos fuerzas opuestas — la defensa que rechaza y lo reprimido que pugna por volver: ambas se satisfacen a medias en él.",
          "Porque el paciente negocia con el analista.",
          "Porque cada síntoma cambia constantemente.",
        ],
        correcta: 1,
        exp: "El concepto de transacción es clave en el primer Freud: si fuera puro éxito de la defensa, no habría síntoma (la representación quedaría afuera). Si fuera retorno puro, no habría disfraz. El síntoma es la salida que ambas fuerzas encuentran: la defensa logra que el contenido no se reconozca, lo reprimido logra que algo se exprese. Ese carácter de compromiso explica la opacidad del síntoma para el sujeto.",
      },
    ],
  },
  ...
  // ---------------------------------------------------------
  {
    ...
    preguntas: [
      ...
      {
        q: "¿Qué es la escisión del yo en la histeria?",
        opciones: [
          "Un trastorno orgánico del cerebro que afecta la integración.",
          "La separación entre el yo y el cuerpo somático.",
          "La coexistencia de dos grupos representativos: uno aceptado por el yo y otro separado, no accesible a la conciencia.",
          "La disociación entre razón y emoción.",
        ],
        correcta: 2,
        exp: "La representación incompatible no se integra al yo: queda escindida, en un grupo psíquico separado. No es un olvido común — coexisten dos grupos representativos. Esto es el comienzo de lo que Freud llamará inconsciente como sistema.",
      },
      {
  ...
  // ---------------------------------------------------------
  {
    ...
    preguntas: [
      ...
      {
        q: "El 'falso enlace' en la transferencia consiste en:",
        opciones: [
          "Una mentira deliberada del paciente.",
          "Un error técnico del analista.",
          "Que el paciente dirige al analista un afecto/reproche que correspondía a otra figura significativa.",
          "Un síntoma somático que aparece durante la sesión.",
        ],
        correcta: 2,
        exp: "Falso enlace: el destinatario actual (el analista) recibe un afecto que pertenece a otra escena (típicamente infantil). La 'equivocación' dice algo verdadero del inconsciente.",
      },
      {
  ...
  // ---------------------------------------------------------
  {
    ...
    preguntas: [
      ...
      {
        q: "Si la representación es reprimida, ¿qué pasa con el afecto ligado a ella?",
        opciones: [
          "Se evapora junto con la representación.",
          "El principio de constancia impide que se pierda: encuentra otro destino (conversión, desplazamiento, proyección).",
          "Queda almacenado intacto y reaparece igual.",
          "Pasa al cuerpo del analista.",
        ],
        correcta: 1,
        exp: "Por el principio de constancia, el monto de afecto no puede disolverse. Si la representación se reprime, el afecto se reparte: conversión (histeria), desplazamiento (obsesiva), proyección (paranoia).",
      },
      {
  ...
  // ---------------------------------------------------------
  {
    ...
    preguntas: [
      ...
      {
        q: "¿Por qué Freud llama al sueño un 'rebus' y no un símbolo a decodificar?",
        opciones: [
          "Porque cada elemento debe leerse como un signo individual a descifrar, no como una letra de un código universal.",
          "Porque los sueños vienen del juego.",
          "Porque siempre hay imágenes infantiles.",
          "Porque no tienen sentido.",
        ],
        correcta: 0,
        exp: "El rebus es un acertijo donde cada figura vale por sí misma como signo. El sueño no se traduce con un diccionario simbólico universal: se descifra elemento por elemento mediante las asociaciones del soñante.",
      },
      {
  ...
  // ---------------------------------------------------------
  {
    ...
    preguntas: [
      ...
      {
        q: "¿Cuál es el rasgo distintivo del proceso primario?",
        opciones: [
          "Pensamiento dirigido y postergación.",
          "Libre circulación de energía, condensación y desplazamiento, búsqueda de identidad perceptiva — gobernado por principio de placer.",
          "Adaptación a la realidad.",
          "Memoria precisa.",
        ],
        correcta: 1,
        exp: "Proceso primario: modo del inconsciente. Energía libre, condensación, desplazamiento, identidad perceptiva (búsqueda de la huella). Principio de placer. Vs proceso secundario: energía ligada, identidad de pensamiento, realidad.",
      },
      {
        q: 'En el sueño "Padre, ¿no ves que estoy ardiendo?", la realización de deseo consiste en:',
        opciones: [
          "Apagar el fuego.",
          "Ver al hijo vivo unos segundos más (frente al apremio de la vida que obliga a despertar).",
          "Castigar al padre.",
          "Soñar con la muerte.",
        ],
        correcta: 1,
        exp: "El padre prolonga unos instantes la ilusión de tener vivo a su hijo. Es el sueño paradigmático: realización de deseo enfrentada al apremio externo (la vela cayó sobre el cadáver). Tensión entre la lógica del inconsciente y la realidad.",
      },
      {
